...
export default function Home() {
  ...
  const handleTwitterLogin = () => {
    ...
    const authEndpoint = new URL("api/auth/twitter", apiUrl).href;
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-sky-100 to-white p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Login with Twitter to post and verify tweets
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1 text-sm">
              <li className="flex items-center justify-center">
                <span className="mr-2">•</span> Post tweets directly from our
                platform
              </li>
              <li className="flex items-center justify-center">
